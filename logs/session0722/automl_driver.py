...
workspace_name = "quick-starts-ws-152157" # PLACEHOLDER
subscription_id = "610d6e37-4747-4a20-80eb-3aad70a55f43" # PLACEHOLDER
resource_group = "aml-quickstarts-152157" # PLACEHOLDER
experiment_name = "Ames-housing-AutoML" # PLACEHOLDER
iteration = "36"  # PLACEHOLDER
run_id = "AutoML_0fc9eea6-09ad-40ac-9ec1-b571665bbd87_36"  # PLACEHOLDER
entry_point = "get_data.py" # PLACEHOLDER
automl_settings = {'path':None,'name':'Ames-housing-AutoML','subscription_id':'610d6e37-4747-4a20-80eb-3aad70a55f43','resource_group':'aml-quickstarts-152157','workspace_name':'quick-starts-ws-152157','region':'southcentralus','compute_target':'cpu-cluster','spark_service':None,'azure_service':'remote','many_models':False,'pipeline_fetch_max_batch_size':1,'enable_batch_run':False,'enable_run_restructure':False,'start_auxiliary_runs_before_parent_complete':False,'enable_code_generation':False,'iterations':1000,'primary_metric':'normalized_root_mean_squared_error','task_type':'regression','data_script':None,'test_size':0.0,'validation_size':0.0,'n_cross_validations':3,'y_min':None,'y_max':None,'num_classes':None,'featurization':'auto','_ignore_package_version_incompatibilities':False,'is_timeseries':False,'max_cores_per_iteration':-1,'max_concurrent_iterations':4,'iteration_timeout_minutes':5,'mem_in_mb':None,'enforce_time_on_windows':False,'experiment_timeout_minutes':120,'experiment_exit_score':None,'whitelist_models':None,'blacklist_algos':['TensorFlowDNN','TensorFlowLinearRegressor'],'supported_models':['TensorFlowLinearRegressor','OnlineGradientDescentRegressor','LightGBM','SGD','TensorFlowDNN','FastLinearRegressor','KNN','LassoLars','DecisionTree','RandomForest','GradientBoosting','XGBoostRegressor','ElasticNet','ExtremeRandomTrees'],'private_models':[],'auto_blacklist':True,'blacklist_samples_reached':False,'exclude_nan_labels':True,'verbosity':20,'_debug_log':'azureml_automl.log','show_warnings':False,'model_explainability':True,'service_url':None,'sdk_url':None,'sdk_packages':None,'enable_onnx_compatible_models':False,'enable_split_onnx_featurizer_estimator_models':False,'vm_type':'STANDARD_D2_V2','telemetry_verbosity':20,'send_telemetry':True,'enable_dnn':False,'scenario':'SDK-1.13.0','environment_label':None,'save_mlflow':False,'force_text_dnn':False,'enable_feature_sweeping':True,'enable_early_stopping':True,'early_stopping_n_iters':10,'metrics':None,'enable_metric_confidence':False,'enable_ensembling':True,'enable_stack_ensembling':True,'ensemble_iterations':15,'enable_tf':False,'enable_subsampling':None,'subsample_seed':None,'enable_nimbusml':False,'enable_streaming':False,'force_streaming':False,'track_child_runs':True,'allowed_private_models':[],'label_column_name':'SalePrice','weight_column_name':None,'cv_split_column_names':None,'enable_local_managed':False,'_local_managed_run_id':None,'cost_mode':1,'lag_length':0,'metric_operation':'minimize','preprocess':True} # PLACEHOLDER
pipeline_spec = "{\"pipeline_id\":\"__AutoML_Ensemble__\",\"objects\":[{\"module\":\"azureml.train.automl.ensemble\",\"class_name\":\"Ensemble\",\"spec_class\":\"sklearn\",\"param_args\":[],\"param_kwargs\":{\"automl_settings\":\"{'task_type':'regression','primary_metric':'normalized_root_mean_squared_error','verbosity':20,'ensemble_iterations':15,'is_timeseries':False,'name':'Ames-housing-AutoML','compute_target':'cpu-cluster','subscription_id':'610d6e37-4747-4a20-80eb-3aad70a55f43','region':'southcentralus','spark_service':None}\",\"ensemble_run_id\":\"AutoML_0fc9eea6-09ad-40ac-9ec1-b571665bbd87_36\",\"experiment_name\":\"Ames-housing-AutoML\",\"workspace_name\":\"quick-starts-ws-152157\",\"subscription_id\":\"610d6e37-4747-4a20-80eb-3aad70a55f43\",\"resource_group_name\":\"aml-quickstarts-152157\"}}]}" # PLACEHOLDER
pipeline_id = "__AutoML_Ensemble__" # PLACEHOLDER
dataprep_json = "{\"training_data\": {\"datasetId\": \"ce8c2dc7-cc90-4d1f-b13d-fef94c47d285\"}, \"datasets\": 0}" # PLACEHOLDER
